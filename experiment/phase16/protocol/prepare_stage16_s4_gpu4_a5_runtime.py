#!/usr/bin/env python3
"""Build and verify the immutable S16-4 GPU4 a5 runtime."""

from experiment.phase16.protocol import prepare_stage16_s4_gpu4_a4_runtime as base


base.DEFAULT_SNAPSHOT = base.ROOT / ".runtime/phase16_s4_toys_gpu4_a5_runtime"
base.CONFIG = "experiment/phase16/configs/stage16_s4_toys_standalone_gpu4_a5.json"
base.EXPECTED_SNAPSHOT_REL = ".runtime/phase16_s4_toys_gpu4_a5_runtime"
base.EXPECTED_PHYSICAL_GPU = 4
base.EXPECTED_MINIMUM_FREE_MIB = 19000
base.MANIFEST_SCHEMA_VERSION = "stage16_s4_toys_gpu4_a5_isolated_runtime_v1"
base.FORMAL_OUTPUT_WRITE_SCOPE = (
    "artifacts/phase16/s4_toys_standalone/formal/toys_seed1502_gpu4_a5"
)
base.OVERLAYS = (
    base.CONFIG,
    ...
    "experiment/phase16/protocol/prepare_stage16_s4_gpu4_a5_runtime.py",
    ...
    "experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a5.sh",
    "experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a5_inner.sh",
    "experiment/phase16/run_stage16_s4_toys_repeat_gpu4_a5_inner.sh",
)
