#!/usr/bin/env python3
"""Build and verify the immutable S16-4 GPU4 a4 runtime."""
...
DEFAULT_SNAPSHOT = ROOT / ".runtime/phase16_s4_toys_gpu4_a4_runtime"
CONFIG = "experiment/phase16/configs/stage16_s4_toys_standalone_gpu4_a4.json"
EXPECTED_SNAPSHOT_REL = ".runtime/phase16_s4_toys_gpu4_a4_runtime"
EXPECTED_PHYSICAL_GPU = 4
EXPECTED_MINIMUM_FREE_MIB = 19000
MANIFEST_SCHEMA_VERSION = "stage16_s4_toys_gpu4_a4_isolated_runtime_v1"
FORMAL_OUTPUT_WRITE_SCOPE = "artifacts/phase16/s4_toys_standalone/formal/toys_seed1502_gpu4_a4"
OVERLAYS = (
    CONFIG,
    ...
    "experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a4.sh",
    "experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a4_inner.sh",
    "experiment/phase16/run_stage16_s4_toys_repeat_gpu4_a4_inner.sh",
)
...
def verify_snapshot(snapshot: Path) -> dict[str, Any]:
    ...
    if (
        config.get("physical_gpu") != EXPECTED_PHYSICAL_GPU
        or config.get("resources", {}).get("minimum_free_mib") != EXPECTED_MINIMUM_FREE_MIB
        ...
        raise ValueError("S16-4 GPU4/repeat isolation contract drift")
    return manifest
