...
SNAPSHOT="$ROOT/.runtime/phase16_s4_toys_gpu4_a5_runtime"
SESSION=phase16_s4_toys_standalone_gpu4_a5
OUTPUT="$ROOT/artifacts/phase16/s4_toys_standalone/formal/toys_seed1502_gpu4_a5"
INNER=experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a5_inner.sh

cd "$ROOT" || exit 2
if [[ -e "$OUTPUT" || -L "$OUTPUT" ]]; then
  echo "Refusing existing S16-4 GPU4 a5 artifact root; formal data cannot be overwritten." >&2
  exit 8
fi
