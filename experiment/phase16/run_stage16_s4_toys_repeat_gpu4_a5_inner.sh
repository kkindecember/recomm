...
FORMAL_STATUS="$HOST_ROOT/artifacts/phase16/s4_toys_standalone/formal/toys_seed1502_gpu4_a5/status.json"
...
if ! "$PYTHON" -m experiment.phase16.protocol.prepare_stage16_s4_gpu4_a5_runtime verify \
