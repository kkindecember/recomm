...
SNAPSHOT="$ROOT/.runtime/phase16_s4_toys_gpu4_a7_runtime"
SESSION=phase16_s4_toys_standalone_gpu4_a7
OUTPUT="$ROOT/artifacts/phase16/s4_toys_standalone/formal/toys_seed1502_gpu4_a7"
INNER=experiment/phase16/run_stage16_s4_toys_standalone_gpu4_a7_inner.sh

cd "$ROOT" || exit 2
if [[ -e "$OUTPUT" || -L "$OUTPUT" ]]; then
  echo "Refusing existing S16-4 GPU4 a7 artifact root; formal data cannot be overwritten." >&2
  exit 8
fi
