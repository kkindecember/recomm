...
- tail-miss norm-only gain: mean=0.017786, 95% CI=[-0.050320, 0.091117], P(>0)=0.457031
- tail-hit norm-only gain mean=-0.318787

### Beauty

- exposure–norm Pearson=-0.952188; `||P20||/||P1||`=5.390997
- tail-miss norm-only gain: mean=-0.851027, 95% CI=[-0.997334, -0.699720], P(>0)=0.148438
- tail-hit norm-only gain mean=-0.621546
